                ...
                <div class="row">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked">
                                    <li class="nav-main active"><a href="<c:url value="/"/>main/supplement/overtime">OverTime</a></li>
                    ...
                    <div class="col-md-10">
                        <div class="panel panel-default">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="input-group">
                                                    <input type="text" id="otSearch" class="form-control" placeholder="Search By Name" onkeyup="otSearchFunction()">
                                    ...
                                    <div class="panel-collapse collapse" id="${profileItem2.id}">
                                        <div class="panel panel-primary">
                                            <div class="panel-heading">
                                                <div class="row">
                                                    <div class="col-md-11">                                                    
                                                        <h5>Overtime Detail : ${profileItem2.firstName} ${profileItem2.lastName}</h5>                                                    
                                                    </div>
                                                    <div class="col-md-1">                                                    
                                                        <input type="button"  class=" btn btn-warning"onclick="printDiv('data_ot${profileItem2.id}')" value="Print" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="panel-body">
                                                <div class="row">
                                                    <table align="right">
                                                        <tr>
                                                            ...
                                                            <td width="250px">
                                                                <select class="form-control input-md" id="month${profileItem2.id}" onchange="tableFilter('month${profileItem2.id}', 'data_ot${profileItem2.id}', 'year${profileItem2.id}')">                                                                    
                                                            ...
                                                            <td width="150px">
                                                                <select class="form-control input-md" id="year${profileItem2.id}" onchange="tableFilter('month${profileItem2.id}', 'data_ot${profileItem2.id}', 'year${profileItem2.id}')">
                                                ...
                                                <table class="table table-bordered" id="data_ot${profileItem2.id}" cellspacing="0">                                                    
                                                    ...
                                                    <c:forEach var="OTItems" items="${overtimeList}">                                                        
                                                        <c:if test="${profileItem2.id == OTItems.empId && OTItems.status == 4}">
                            ...
                            <c:if test="${userInfo.user.permission == 'EMPLOYEE'||userInfo.user.permission == 'LEADER'}">
                                    ...
                                    <body>
                                        <div class="container-fluid">            
                                            ...
                                            <div class="container">
                                                <center>
                                                    <br><br><br>
                                                    <h3>Please add your profile before add over time.</h3>
                                                </center>
                                            </div>
                                        </div>
                                    </body>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <div class="panel panel-default">
                                                                <div class="panel-body">
                                                                    <ul class="nav nav-pills nav-stacked">
                                                                        <li class="nav-main active"><a href="<c:url value="/"/>main/overtime">OverTime</a></li>
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="panel panel-default">                                                            
                                                                <div class="panel-body">
                                                                    <div class="row">
                                                                        &nbsp;&nbsp;&nbsp;&nbsp;<a href="overtime/addForm?empId=${profileItem2.id}" class="btn btn-primary" style="size:100;">Add Overtime</a>
                                                                        <table align="right">
                                                                            <tr>
                                                                                <td width="50" align="center">Month:</td>
                                                                                <td width="250px">
                                                                            ...
                                                                            <c:if test="${profileItem2.id == OTItems.empId}">
                                                                                <c:if test="${OTItems.dayName == 'Sat' || OTItems.dayName == 'Sun'}">                                                                               
                                                                                    <tr bgcolor="D3F6FF">                                                                                        
                                                                                        ...
                                                                                        <td align="center">${OTItems.description}</td>
                                                                                        <td align="center">${OTItems.remark}</td>
                                                                                        <c:if test="${OTItems.status > 0 && OTItems.status < 4}">
                                                                                            <td align="center" bgcolor="#FDFBAC">Processing</td>
                                                                                        </c:if>
                                                                                        <c:if test="${OTItems.status == 4}">
                                                                                            <td align="center" bgcolor="#ACFDBC">Approved</td>
                                                                                        </c:if>
                                                                                        <c:if test="${OTItems.status == 5}">
                                                                                            <td align="center" bgcolor="#FDCBAC">Rejected</td>
                                                                                        </c:if>
                                                                                        <c:if test="${OTItems.status == 0}">
                                                                                            <td align="center">
                                                                                                <a href="<c:url value="/"/>main/overtime/editForm/${OTItems.id}?empId=${profileItem2.id}" class="btn btn-warning">Edit </a>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>                                                                                        
                                                                                            ...
                                                                                            <c:if test="${OTItems.status > 0 && OTItems.status < 4}">
                                                                                                ...
                                                                                                <c:if test="${checkLeader == 0 || checkLeader == 1 && OTItems.status != 1}">
                                                                                                    <td align="center" bgcolor="#FDFBAC">Processing</td>
                                                                                                </c:if>

                                                                                                <c:if test="${checkLeader == 1 && OTItems.status == 1}">
                                                                                                    <td align="center">
                                                                                                        <a href="<c:url value="/"/>main/overtime/editForm/${OTItems.id}?empId=${profileItem2.id}" class="btn btn-warning">Edit </a>
                                                                                                        <a href="<c:url value="/"/>main/overtime/delete/${OTItems.id}?empId=${profileItem2.id}"class="btn btn-danger"> Delete</a></  
                                                                                                    </td>
