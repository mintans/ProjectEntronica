                                                        ...
                                                        <thead>
                                                            ...
                                                            <c:forEach var="educationList2" items="${educationItem.education.educationInfo}"
                                                                ...
                                                                <c:if test="${educationList2.institution != null}">
                                                                        ...
                                                                        <td><form:input type="text" OnKeyPress="return checknum(this)" class="form-control" name="educationInfo[${counter.index}].from"  path="educationInfo[${counter.index}].from" value="${educationList2.from}" required="true"  /></td>
                                                                        <td><form:input type="text" class="form-control" name="educationInfo[${counter.index}].to"    path="educationInfo[${counter.index}].to" value="${educationList2.to}" required="true"   OnKeyPress="return checknum(this)"/></td>
                                                                        <td><form:input type="text" class="form-control" name="educationInfo[${counter.index}].gpa" path="educationInfo[${counter.index}].gpa" value="${educationList2.gpa}" required="true"  OnKeyPress="return checknum(this)"/></td>
