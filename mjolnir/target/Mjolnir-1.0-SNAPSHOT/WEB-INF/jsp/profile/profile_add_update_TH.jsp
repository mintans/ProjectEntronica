                                ...
                                <form:form  method="POST" action="${action}" commandName="profileForm">
                                    ...
                                    <div class="row col-md-offset-1">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <div class="col-md-6">
                                                <form:input type="text" class="form-control" path="age" required="age" value=""  OnKeyPress="return checknum(this)"/>
                                            </div>
                                    ...
                                    <div class="row col-md-offset-1">
                                        <div class="form-group col-md-7">
                                            ...
                                            <div class="col-md-6">
                                                <form:input class="form-control" path="cardno" required="cardno" onkeyup="autoTab2(this,1)" value=""  OnKeyPress="return checknum(this)"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row col-md-offset-1">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="col-md-3">
                                                <form:input class="form-control" path="height" required="height" value="" placeholder="180cm"  OnKeyPress="return checknum(this)"/>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="weight" class="col-md-4 control-label">น้ำหนัก</label>
                                            <div class="col-md-7">
                                                <form:input class="form-control" path="weight" required="weight" value="" placeholder="70kg"  OnKeyPress="return checknum(this)"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row col-md-offset-1">
                                        <div class="form-group col-md-7">
                                            ...
                                            <div class="col-md-6">
                                                <form:input class="form-control" path="bankAccountNo" required="bankAccountNo" onkeyup="autoTab2(this,4)" value=""  OnKeyPress="return checknum(this)"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row col-md-offset-1">
                                        <div class="form-group col-md-7">
                                            ...
                                            <div class="col-md-6">
                                                <form:input class="form-control" path="postCodeRegistration" required="postCodeRegistration" value=""  OnKeyPress="return checknum(this)"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row col-md-offset-1">
                                    ...
                                    <div class="row col-md-offset-1">
                                        <div class="form-group col-md-7">
                                            ...
                                            <div class="col-md-6">
                                                <form:input class="form-control" path="postCodeCurrent" required="postCodeCurrent" value=""  OnKeyPress="return checknum(this)"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row col-md-offset-1">
                                        <div class="form-group col-md-7">
                                            ...
                                            <div class="col-md-6">
                                                <form:input class="form-control" path="tel" required="tel" onkeyup="autoTab2(this,3)" value=""  OnKeyPress="return checknum(this)"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row col-md-offset-1">
                                        <div class="form-group col-md-7">
                                            ...
                                            <div class="col-md-6">
                                                <form:input class="form-control" path="mobile" required="mobile" onkeyup="autoTab2(this,2)" value=""  OnKeyPress="return checknum(this)"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row col-md-offset-1">
                                    ...
                                    <div class="row col-md-offset-1">
                                        <div class="form-group col-md-7">
                                            ...
                                            <div class="col-md-6">
                                                <form:input class="form-control" path="relatedApplicantTel" required="relatedApplicantTel" onkeyup="autoTab2(this,2)" value=""  OnKeyPress="return checknum(this)"/>
                                            </div>
                                        </div>
                                    </div>    
