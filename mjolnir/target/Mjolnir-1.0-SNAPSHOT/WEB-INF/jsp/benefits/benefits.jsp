                                            ...
                                            <c:forEach var="benefitsItem" items="${benefitsList}">
                                                ...
                                                <tr>                                                
                                                    ...
                                                    <td align="center">
                                                        ...
                                                        <a href="<c:url value="/"/>main/benefits/delete/${benefitsItem.id}" class="btn btn-danger"  OnClick="return confirmDelete();" > Delete</a>
                                                    </td>
                                                </tr>
                                            </c:forEach>                                    
                                        </tbody>
                                                ...
                                                <c:forEach var="employmentTypeItem" items="${employmentTypeList}">
                                                    ...
                                                    <tr>                                                
                                                        ...
                                                        <td align="center">
                                                            ...
                                                            <a href="<c:url value="/"/>main/benefits/deleteEmploymentType/${employmentTypeItem.id}" class="btn btn-danger" OnClick="return confirmDelete();"> Delete</a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>                                    
                                            </tbody>
