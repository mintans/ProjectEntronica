...
<html>
    ...
    <c:if test="${action == 'save'}">
        ...
        <c:if test="${action == 'update' || action == 'addleader'}">
        <body>
        </c:if>    
        <div class="container-fluid">
            ...
            <c:if test="${action == 'save' || action == 'update'}">
            ...
            <c:if test="${action == 'addleader'}">
            <nav class="breadcrumb">
                <a class="breadcrumb-item" href="<c:url value="/"/>main/structure/overview/${userInfo.user.id}">Structure</a> /
                <a class="breadcrumb-item" href="<c:url value="/"/>main/team">Team</a> /
                <span class="breadcrumb-item active">Add Leader</span>
            </nav>
            </c:if>
                    ...
                    <div class="col-md-10">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                ...
                                <c:if test="${action == 'addleader'}">
                                    <h4 class="panel-title">Change Permission</h4>
                                </c:if>
                            </div>
                            <div class="panel-body">
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <c:if test="${action == 'addleader'}">
                                                    <input class="form-control input-md" id="id" type="hidden" name="id" readonly="true" value="${id}"/>
                                                </c:if>
                                            </div>
                                        </div>
                                        ...
                                        <c:forEach var="userItem" items="${userList}">
                                            <c:if test="${action == 'addleader' && userItem.id == id}">
                                                <div class="form-group">
                                                      
                                                    <div class="col-md-4">                                                   
                                                        <input class="form-control input-md" value="${userItem.username}" readonly="true" type="hidden" name="username" placeholder="Enter username" required="username"/>                          
                                                        <input type="hidden" value="${userItem.urlId}" name="urlId" readonly="true"/>
                                                        <input type="hidden" value="${userItem.checkPWD}" name="checkPWD" readonly="true"/>
                                                        <input type="hidden" value="${userItem.password}" name="password" readonly="true"/>
                                                    </div>
                                        ...
                                        <c:forEach var="userItem" items="${userList}">
                                            <c:if test="${action == 'addleader' && userItem.id == id}">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="hidden" class="form-control input-md" value="${userItem.email}" readonly="true" name="email" />
                                                    </div>
                                                </div>
                                            </c:if>
                                        </c:forEach>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select class="form-control input-md" name="permission">
                                                            ...
                                                            <c:if test="${userItem.permission == 'LEADER'}">
                                                                <option selected="LEADER">LEADER</option>
                                                            </c:if>
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <c:forEach var="userItem" items="${userList}">
                                            <c:if test="${action == 'addleader' && userItem.id == id}">
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label" for="textinput">Change Permission:</label>  
                                                    <div class="col-md-4">
                                                        <select class="form-control input-md" name="permission" style="border: 3px red solid">
                                                            <c:if test="${userItem.permission == 'EMPLOYEE'}">
                                                                <option selected="EMPLOYEE">EMPLOYEE</option>
                                        ...
                                        <c:forEach var="userItem" items="${userList}">
                                            <c:if test="${action == 'addleader' && userItem.id == id}">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="hidden" name="startWorkDate" class="form-control input-md" style="width: 100%" value="${userItem.startWorkDate}" readonly="true" required="startWorkDate">
                                                    </div>
                                                </div>
                                            </c:if>
                                        </c:forEach>
                                        ...
                                        <c:forEach var="userItem2" items="${userList}">
                                            <c:if test="${action == 'addleader' && userItem2.id == id}">
                                                <div class="form-group">
                                                                                                        
                                                    <div class="col-md-4" style="display:none">                                                
                                                        <select class="form-control" name="employmentType" id="employmentType" required="employmentType">                                                    
                                                            <c:forEach var="employmentTypeItem2" items="${employmentTypeList}">  
                                                                <c:if test="${employmentTypeItem2.employmentTypeName == employmentTypeUsed}">
                                                                    <option typeName="${employmentTypeItem2.typeName}" selected="${employmentTypeUsed}" value="${employmentTypeItem2.employmentTypeName}">${employmentTypeItem2.employmentTypeName}</option>
                                                                </c:if>    
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <c:if test="${action == 'addleader'}">
                                                    <input type="submit" value="Save" class="btn btn-success">
                                                    <a href="<c:url value="/"/>main/team"class="btn btn-primary">Cancel</a>
                                                </c:if>
                                            </div>
                                        </div>
                                    </fieldset>
