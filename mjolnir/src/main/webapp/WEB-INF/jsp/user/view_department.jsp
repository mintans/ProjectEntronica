                                                                        ...
                                                                        <c:if test="${userItem.permission == 'MANAGER'}">
                                                                            <c:forEach var="profileList" items="${profileList}">
                                                                                ...
                                                                                <c:forEach  var="departmentsItem" items="${departmentsList}">
                                                                                    <c:if test="${profileList.id == departmentsItem.managerName }">
                                                                                    <c:set var="ch" value="1"/>
                                                                                    </c:if>
                                                                                </c:forEach>
                                                                                <c:if test="${profileList.id == userItem.id}">
                                                                                    <c:if test="${ch == 0}">
                                                                                    <option value="${profileList.id}">${profileList.firstName} ${profileList.lastName}</option>
                                                                                    </c:if>
                                                                                </c:if>
                                                                            </c:forEach>
                                                                        </c:if>
                                    ...
                                    <tbody>                                        
                                        <c:forEach var="departmentItem" items="${departmentsList}">
                                            ...
                                            <tr>                                                
                                                ...
                                                <c:if test="${profileItem.id == departmentItem.managerName}">
                                                <td align="center">${profileItem.firstName} ${profileItem.lastName}</td>
                                                </c:if>
                                                </c:forEach>
                                                <td align="center">
                                                    ...
                                                    <a href="<c:url value="/"/>main/departments/delete/${departmentItem.id}"class="btn btn-danger" OnClick="return confirmDelete();"> Delete</a></td>
                                            </tr>
                                        </c:forEach>                                    
                                    </tbody>
                                </table>
