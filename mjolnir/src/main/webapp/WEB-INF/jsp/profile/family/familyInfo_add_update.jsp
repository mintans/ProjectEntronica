                                ...
                                <form:form  method="POST" action="${action}" commandName="familyInfoForm">
                                    ...
                                    <div class="row col-md-offset-1">
                                        <div class="form-group col-md-8">
                                            ...
                                            <div class="col-md-6">
                                                <form:input class="form-control" path="fatherAge" required="fatherAge" value="" OnKeyPress="return checknum(this)"/>
                                            </div>                
                                        </div>
                                    </div>
                                    <div class="row col-md-offset-1">
                                    ...
                                    <div class="row col-md-offset-1">
                                        <div class="form-group col-md-8">
                                            ...
                                            <div class="col-md-6">
                                                <form:input class="form-control" path="motherAge" required="motherAge" value="" OnKeyPress="return checknum(this)"/>
                                            </div>                
                                        </div>
                                    </div>
                                    <div class="row col-md-offset-1">
                                    ...
                                    <div class="row col-md-offset-1">
                                        <div class="form-group col-md-8">
                                            ...
                                            <div class="col-md-6">
                                                <form:input class="form-control" path="spouseAge" required="spouseAge" value="" OnKeyPress="return checknum(this)"/>
                                            </div>                
                                        </div>
                                    </div>
                                    <div class="row col-md-offset-1">
                                    ...
                                    <div class="row col-md-offset-1">
                                        <div class="form-group col-md-8">
                                            ...
                                            <div class="col-md-6">
                                                <form:input class="form-control" path="numberChildren" required="numberChildren" value="" OnKeyPress="return checknum(this)"/>
                                            </div>                
                                        </div>
                                    </div>
                                    <div class="row col-md-offset-1">
                                    ...
                                    <div class="row col-md-offset-1">
                                        <div class="form-group col-md-8">
                                            ...
                                            <div class="col-md-6">
                                                <form:input class="form-control" path="numberFamily" required="numberFamily" value="" OnKeyPress="return checknum(this)"/>
                                            </div>                
                                        </div>
                                    </div>
