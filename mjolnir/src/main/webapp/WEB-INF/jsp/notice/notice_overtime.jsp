                                    ...
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <c:forEach var="OTItems1" items="${overtimeList}">
                                                <c:if test="${OTItems1.status == 0 || OTItems1.status == 4 || OTItems1.status == 2}">
                                            ...
                                            <c:if test="${check1 == 1}">
                                                ...
                                                <table class="table table-bordered" cellspacing="0" id="overtime">
                                                    ...
                                                    <c:forEach var="OTItems" items="${overtimeList}">
                                                        ...
                                                        <c:if test="${OTItems.status == 0 || OTItems.status == 2|| OTItems.status == 4}">                                                            
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <c:if test="${OTItems.status == 0 || OTItems.status == 2}">
                                                                        <td align="center">
                                                ...
                                                <table class="table table-bordered" cellspacing="0" id="overtime">
                                                    ...
                                                    <c:forEach var="OTItems" items="${overtimeList}">
                                                        <c:forEach var="userItem" items="${userList}">
                                                            <c:if test="${userItem.id == OTItems.empId && userInfo.user.departmentName == userItem.departmentName}">
                                                        <c:forEach var="profileItems" items="${profileList}">
                                                            <c:if test="${profileItems.id == OTItems.empId}">
                                                                <c:set var="name" value="${profileItems.firstName} ${profileItems.lastName}"></c:set>
                                                            </c:if>
                                                        ...
                                                        <c:if test="${OTItems.status == 3}">                                                            
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <c:if test="${OTItems.status == 3}">
                                                                        <td align="center">
                                                                            <a href="<c:url value="/"/>main/managerApproveOT/${OTItems.id}" class="btn btn-success">Approve </a>
                                                                            <a href="<c:url value="/"/>main/RejectOT/${OTItems.id}"class="btn btn-danger">Reject</a></td>  
                                                                        </td>
                                                                    </c:if>
                                                                </tr>
                                                            </tbody> 
                                                        ...
                                                        <c:if test="${OTItems.status == 1}">                                                            
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <c:if test="${OTItems.status == 1}">
                                                                        <td align="center">
                                                                            <a href="<c:url value="/"/>main/leaderAllowOT/${OTItems.id}" class="btn btn-success">Allow </a>
                                                                            <a href="<c:url value="/"/>main/RejectOT/${OTItems.id}"class="btn btn-danger">Not Allow</a></td>  
                                                                        </td>
                                                                    </c:if>
                                                                </tr>
