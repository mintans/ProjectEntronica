                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        ...
                                                                                        <c:if test="${paymentItems.status > 0 && paymentItems.status < 4}">
                                                                                            ...
                                                                                            <c:if test="${userInfo.user.permission == 'EMPLOYEE'||userInfo.user.permission == 'LEADER' }">
                                                                                                <c:if test="${userInfo.user.permission == 'EMPLOYEE' && paymentItems.status != 1}">
                                                                                                    <td align="center" bgcolor="#FDFBAC">Processing</td>
                                                                                                </c:if>
                                                                                                    <c:if test="${userInfo.user.permission == 'LEADER' && paymentItems.status != 0}">
                                                                                                    <td align="center" bgcolor="#FDFBAC">Processing</td>
                                                                                                </c:if>
                                                                                        ...
                                                                                        <c:if test="${paymentItems.status == 6}">
                                                                                            <td align="center" bgcolor="#ACFDBC">Approved</td>
                                                                                        </c:if>
                                                                                        <c:if test="${paymentItems.status == 5}">
                                                                                            <td align="center" bgcolor="#FDCBAC">Rejected</td>
