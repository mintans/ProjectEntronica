                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        ...
                                                                                        <c:if test="${LeaveItems.status == 0}">
                                                                                            <td align="center">
                                                                                                <a href="<c:url value="/"/>main/leave/editForm/${LeaveItems.id}?empId=${profileItem2.id}&start=${profileItem2.startWorking}" class="btn btn-warning">Edit </a>
                                                                                                <a href="<c:url value="/"/>main/leave/delete/${LeaveItems.id}?empId=${profileItem2.id}&start=${profileItem2.startWorking}" class="btn btn-danger"> Delete</a>  
                                                                                            </td>
                                                                                        </c:if>
                                                                                    </tr>
                                                                                </tbody>
