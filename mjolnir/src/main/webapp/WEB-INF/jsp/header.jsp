            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <c:if test="${userInfo.user.permission == 'ADMIN'}">
                        <c:if test="${formhome == 'home'}">
                         ...
                         <c:if test="${userInfo.user.permission == 'MANAGER'}">
                            ...
                            <c:if test="${check == 0}">
                            <li class="nav-main"><a href="<c:url value="/main/noprofile"/>">Profile</a></li>
                            </c:if>
                            <li class="nav-main"><a href="<c:url value="/main/leave"/>">Supplement</a></li>
                            <li class="nav-main"><a href="<c:url value="/main/structure/overview/${userInfo.user.id}"/>">Structure</a></li>
                            ...
                            <c:if test="${check == 0}">
                            <li><a href="<c:url value="/main/noprofile"/>">Profile</a></li>
                            </c:if>
                            <li><a href="<c:url value="/main/leave"/>">Supplement</a></li>
                            <li><a href="<c:url value="/main/structure/overview/${userInfo.user.id}"/>">Structure</a></li>
                            ...
                            <li><a href="<c:url value="/main/leave"/>">Supplement</a></li>                           
                            <li class="active"><a href="<c:url value="/main/structure/overview/${userInfo.user.id}"/>">Structure</a></li>
                            <li><a href="<c:url value="/main/document"/>">Document</a></li>
                            </c:if>
                    ...
                    <c:if test="${userInfo.user.permission == 'EMPLOYEE' || userInfo.user.permission == 'LEADER'}">
                        <c:if test="${formhome == 'home'}">
                            <li class="nav-main"><a href="<c:url value="/main/notice/personal"/>">Notice</a></li>
                            <c:if test="${check == 1}">
                            <li class="nav-main"><a href="<c:url value="/main/information/view/${userInfo.user.id}"/>">Profile</a></li>
                            </c:if>
                            <c:if test="${check == 0}">
                            ...
                            <c:if test="${formNotice == 'notice'}">
                            <li class="active"><a href="<c:url value="/main/notice/personal"/>">Notice</a></li>
                            <c:if test="${check == 1}">
                            <li><a href="<c:url value="/main/information/view/${userInfo.user.id}"/>">Profile</a></li>
                            </c:if>
                            <c:if test="${check == 0}">
                            ...
                            <c:if test="${formProfile == 'profile'}">
                            <li><a href="<c:url value="/main/notice/personal"/>">Notice</a></li>
                            <c:if test="${check == 1}">
                            <li class="active"><a href="<c:url value="/main/information/view/${userInfo.user.id}"/>">Profile</a></li>
                            </c:if>
                            <c:if test="${check == 0}">
                            <li class="active"><a href="<c:url value="/main/noprofile"/>">Profile</a></li>
                            </c:if>
                            <li><a href="<c:url value="/main/overtime"/>">Supplement</a></li>
                            <li><a href="<c:url value="/main/document"/>">Document</a></li>
                            </c:if>
