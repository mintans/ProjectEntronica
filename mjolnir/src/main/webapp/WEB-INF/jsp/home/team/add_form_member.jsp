                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">   
                            ...
                            <form:select class="form-control input-md" path="memberId" required="true">
                                <c:forEach var="pItem" items="${proList}">
                                    ...
                                    <c:forEach  var="userItem" items="${userList}">
                                        <c:if test="${userItem.permission == 'MANAGER' || userItem.permission == 'ADMIN'}">
