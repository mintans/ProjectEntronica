...
public class UserController {
    ...
    @RequestMapping(value = "editForm2/{userId}", method = RequestMethod.GET)
    public String addLeaderEdit(ModelMap model, @PathVariable String userId) {
        List<Departments> departmentsList = departmentManager.getAll();
        model.put("departmentsList", departmentsList);
    ...
    @RequestMapping(value = "editForm2/addleader", method = RequestMethod.POST)
    public String leaderUpdate(@ModelAttribute("userForm") UserForm userForm, ModelMap model, HttpServletResponse response) throws IOException {
